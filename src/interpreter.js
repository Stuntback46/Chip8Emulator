...
function opcodeInterpreter(opcode) {
    ...
    if (opcode === 0x00E0) {
        ...
        callstack.pileStack = callstack.pileStack - 1;
        ...
        callstack.stackPointer[callstack.pileStack] = (((opcode) & (0x0FFF)) - 2)
        ...
        callstack.stackPointer[callstack.pileStack] = ((((opcode) & (0x0FFF)) + registers.Vx[0]) - 2)
        ...
        var n = ((opcode) & (0x000F));
        screen.display(n, registers.Vx[x], registers.Vx[y], registers.I);
        ...
        //FX1E
        //Adds VX to I.
        I = registers.Vx[x] + registers.I;
        if (I > 0xFFF) {
            registers.Vx[15] = 1;
        } else {
            registers.Vx[15] = 0;
        }
        registers.I = I & 0x0FFFF;
        ...
        for (var i = 0; i <= x; i++) {
            memory.ram[registers.I + i] = registers.Vx[i];
        }
        ...
        // The offset from I is increased by 1 for each value written, but I itself is left unmodified.
        for (var i = 0; i <= x; i++) {
            registers.Vx[i] = memory.ram[registers.I + i];
